...
public class CDependsOnAOrB {


    @Test
    public void testCDependsOnAOrBNoDupesInFile() throws IOException {
        ...
        //Make sure EVERY A has corresponding C
        ...
        assertThat("We expect this to fail", cContents, not(Matchers.hasDuplicateInArray()));
    ...
    @Test
    public void testCDependsOnAOrBNoDupesInFileDistinctBeforeSubscriptions() throws IOException {
        //DEALS with only A's, B's, and C's
        //Ignores everything else
        //Doesn't care about missed things
        //Every A record causes C records of same id to need updating
    ...
    @Test
    public void testCDependsOnAOrBDupesInFileDistinctBeforeSubscriptions() throws IOException {
        //DEALS with only A's, B's, and C's
        //Ignores everything else
        //Doesn't care about missed things
        //Every A record causes C records of same id to need updating
    ...
    @Test
    public void testCDependsOnAOrBDupesInFileDistinctAfterChangedAndBeforeSubscriptions() throws IOException {
        //DEALS with only A's, B's, and C's
        //Ignores everything else
        //Doesn't care about missed things
        //Every A record causes C records of same id to need updating
